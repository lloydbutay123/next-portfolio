                ...
                <div className="lg:flex gap-[4em]">
                    ...
                    <div className="flex flex-1 flex-col">
                        ...
                        <div className="flex flex-wrap leading-none lg:w-[80%]">
                            <span className="text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] mr-[10px] text-[#888888] font-bold">
                                Hello, I am Lloyd.
                            </span>
                            <p className="text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] font-bold mr-[10px] text-black">A</p>
                            <span className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] mr-[10px] border-b-2 border-[#888888] border-dashed font-bold">
                                web
                            </span>
                            <p className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] font-bold mr-[10px]">&</p>
                            <span className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] mr-[10px] border-b-2 border-[#888888] border-dashed font-bold">
                                mobile
                            </span>
                            <p className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] font-bold mr-[10px]">developer with an</p>
                            <span className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] mr-[10px] border-b-2 border-[#888888] border-dashed font-bold">
                                architecture
                            </span>
                            <p className="text-black text-[49px] md:text-[4em] lg:text-[78.4px] md:leading-[1em] md:tracking-[-0.3vh] font-bold mr-[10px]">background.</p>
                        </div>
                    </div>
                </div>
            </div>
