        ...
        <div className="relative z-10 bg-white pb-[42px]">
          <div className="lg:flex gap-[4em] px-3.5 md:px-[42px] mt-4">
            ...
            <AnimatedText className="hidden lg:block w-[300px] text-end text-[14px] text-[#000000]">
              The fear of being just another face in the crowd drives everything
              I do—it’s the force behind my determination to push boundaries,
              take risks, and make sure that what I create or achieve is truly
              unforgettable.
            </AnimatedText>
          </div>
          <AboutSection />
